...
const { getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, banner, start, info, success, close, open} = require('./lib/functions')
...
async function starts() {
   ...
   fs.existsSync('./fxsx.json') && fxsx.loadAuthInfo('./fxsx.json')
   fxsx.on('connecting', () => {
      start('2', 'Connecting...')
   })
   fxsx.on('open', () => {
   ...
   fs.writeFileSync('./fxsx.json', JSON.stringify(fxsx.base64EncodedAuthInfo(), null, '\t'))
